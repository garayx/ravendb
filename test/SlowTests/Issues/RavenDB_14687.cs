...
namespace SlowTests.Issues
{
    public class RavenDB_14687 : RavenTestBase
    {
        ...
        public async Task IndexSpecificSettingShouldBeRespected(Options options)
        {
            ...
            var initialEngineForScript = JavaScriptEngineType.V8;
          ...
          //      record.Settings[RavenConfiguration.GetKey(x => x.Indexing.EngineForScript)] = initialEngineForScript.ToString();
            ...
            using (var store = GetDocumentStore(options))
            {
                ...
                var compiled1 = (JavaScriptIndexJint)indexInstance1._compiled;
           ...
           //     Assert.Equal(initialStrictModeForScript, compiled1.EngineHandle.JsOptions.StrictMode);
                ...
                Assert.Equal(initialEngineForScript, compiled1.EngineHandle.JsOptions.EngineType);
            ...
            //    var maxDurationForScript = new TimeSetting(101, TimeUnit.Milliseconds);
                index = new MyJSIndex(options, null,/*strictModeForScript,*/ maxStepsForScript,null/*, maxDurationForScript*/);
                index.Execute(store);

                Indexes.WaitForIndexing(store);

                var indexInstance2 = (MapIndex)database.IndexStore.GetIndex(index.IndexName);
                var compiled2 = (JavaScriptIndexJint)indexInstance2._compiled;
              ...
              //  Assert.Equal(strictModeForScript, compiled2.EngineHandle.JsOptions.StrictMode);
                ...
                //TODO: egor change the engine here as well?
                Assert.Equal(initialEngineForScript, compiled1.EngineHandle.JsOptions.EngineType);
