...
-- 'default_with_oids' was removed in PostgreSQL 12+; the original pg_dump line
-- (`SET default_with_oids = false;`) was stripped because modern servers reject
-- it with "unrecognized configuration parameter" and abort the whole script.
