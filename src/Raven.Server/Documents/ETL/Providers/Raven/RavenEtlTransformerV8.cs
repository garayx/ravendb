...
public class RavenEtlTransformerV8 : RavenEtlTransformerBase<JsHandleV8>
{
    ...
    public override RavenEtlScriptRun<JsHandleV8> CreateRavenEtlScriptRun(EtlStatsScope stats, Transformation transformation)
    {
        return new RavenEtlScriptRunV8(EngineHandle, stats, transformation);
    }
