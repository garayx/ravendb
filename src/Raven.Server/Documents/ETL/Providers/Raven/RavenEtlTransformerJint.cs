...
public class RavenEtlTransformerJint : RavenEtlTransformerBase<JsHandleJint>
{
    ...
    public override RavenEtlScriptRun<JsHandleJint> CreateRavenEtlScriptRun(EtlStatsScope stats, Transformation transformation)
    {
        return new RavenEtlScriptRunJint(EngineHandle, stats, transformation);
    }
