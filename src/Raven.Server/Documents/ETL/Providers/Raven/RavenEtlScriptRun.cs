...
namespace Raven.Server.Documents.ETL.Providers.Raven
{
    ...
    where T : struct, IJsHandle<T>
    {
        ...
        protected RavenEtlScriptRun(IJsEngineHandle<T> jsEngineHandle, EtlStatsScope stats, Transformation transformation)
        {
    ...
    {
        public RavenEtlScriptRunV8(IJsEngineHandle<JsHandleV8> engine, EtlStatsScope stats, Transformation transformation) : base(engine, stats, transformation)
        {
        }
    }
    ...
    {
        public RavenEtlScriptRunJint(IJsEngineHandle<JsHandleJint> engine, EtlStatsScope stats, Transformation transformation) : base(engine, stats, transformation)
        {
        }
    }
}
