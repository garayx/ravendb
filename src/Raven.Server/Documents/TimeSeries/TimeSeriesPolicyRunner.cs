...
namespace Raven.Server.Documents.TimeSeries
{
    public class TimeSeriesPolicyRunner : BackgroundWorkBase
    {
        ...
        public TimeSeriesPolicyRunner(DocumentDatabase database, TimeSeriesConfiguration configuration)
            : base(database.DatabaseShutdown, database.DocumentsStorage.TimeSeriesStorage._logger.GetLoggerFor(nameof(TimeSeriesPolicyRunner), LogType.Database))
        {
            _database = database;
        ...
        public static TimeSeriesPolicyRunner LoadConfigurations(DocumentDatabase database, DatabaseRecord dbRecord, TimeSeriesPolicyRunner policyRunner)
        {
            ...
            catch (Exception e)
            {
                ...
                var logger = database.DocumentsStorage.TimeSeriesStorage._logger.GetLoggerFor(nameof(TimeSeriesPolicyRunner), LogType.Database);
