...
namespace Raven.Server.Documents.Handlers.Processors.Smuggler
{
        ...
        where TOperationContext : JsonOperationContext
    {
        ...
        internal SmugglerHandlerProcessorForValidateOptions(RequestHandler requestHandler, JsonContextPoolBase<TOperationContext> contextPool, RavenConfiguration configuration, CancellationToken token) : base(requestHandler, contextPool)
        {
