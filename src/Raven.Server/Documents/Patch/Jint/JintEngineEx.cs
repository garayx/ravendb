...
";
        ...
        {
            /* TODO: egor add shlomo jint update?
        ...
        public JsHandleJint CreateObject()
        {
            ...
            return new JsHandleJint(o); //new ObjectInstance(this));
        }
        ...
        public JsHandleJint CreateArray2(IEnumerable<JsHandleJint> items)
        {
            var empty = true;
        ...
        {
            return new JsHandleJint(value ? JsBoolean.True : JsBoolean.False);
        }
        ...
        {
            return new JsHandleJint(new JsDate(Engine, value));
        }
