...
namespace Raven.Server.Utils
{
    ...
    {
        private static readonly Logger Logger = LoggingSource.Instance.GetGenericLogger().GetLoggerFor(Logger.GetNameFor(nameof(MachineResources), nameof(ThreadsUsage)), LogType.Server);
