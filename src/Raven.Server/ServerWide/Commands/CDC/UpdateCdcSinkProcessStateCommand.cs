...
public sealed class UpdateCdcSinkProcessStateCommand : UpdateValueForDatabaseCommand
{
    ...
    public UpdateCdcSinkProcessStateCommand(string databaseName, CdcSinkProcessState state, bool hasHighlyAvailableTasks, string uniqueRequestId) : base(databaseName, uniqueRequestId)
    {
        State = state;
