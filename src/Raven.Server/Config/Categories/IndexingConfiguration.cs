...
namespace Raven.Server.Config.Categories
{
    ...
    public class IndexingConfiguration : ConfigurationCategory
    {
        ...
        [DefaultValue(JavaScriptEngineType.None)]
        [IndexUpdateType(IndexUpdateType.Reset)]
        [ConfigurationEntry(Constants.Configuration.Indexes.IndexingEngineForScript, ConfigurationEntryScope.ServerWideOrPerDatabaseOrPerIndex)]
        public JavaScriptEngineType EngineForScript { get; protected set; }
