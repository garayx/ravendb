...
namespace Raven.Client.Documents.Session.Operations
{
    internal sealed class BatchOperation
    {
        ...
        public SingleNodeBatchCommand CreateRequest()
        {
            ...
            return new SingleNodeBatchWithTrackingCommand(_session.Conventions, _session.Context, result.SessionCommands, result.TrackChangesCommandData, result.Options);
        }
