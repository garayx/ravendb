...
namespace Raven.Client.Http
{
    ...
    {
        private static readonly Logger _logger = LoggingSource.Instance.GetLogger<dynamic>(LoggingSource.Generic).GetLoggerFor(nameof(DatabaseTopologyLocalCache), LogType.Client);
